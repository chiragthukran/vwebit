...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://vwebit.com/packers-movers-website-development" },
  openGraph: {
    title: "Website for Packers and Movers in India | Vwebit",
    description: "Get more shifting enquiries with a professional packers & movers website. Starting from ₹15,000.",
    url: "https://vwebit.com/packers-movers-website-development",
  },
};
    ...
    <>
      ...
      <section className="py-16 px-6 md:px-12 bg-[var(--color-primary)]">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-[var(--color-primary-fixed-dim)] mb-8 max-w-lg mx-auto">Get a free website audit and see exactly how to grow your packers and movers business online.</p>
