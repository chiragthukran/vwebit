...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://vwebit.com/clinic-website-design" },
  openGraph: {
    ...
    url: "https://vwebit.com/clinic-website-design",
  },
};
    ...
    <>
      ...
      <section className="py-16 px-6 md:px-12 bg-[var(--color-primary)]">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-[var(--color-primary-fixed-dim)] mb-8 max-w-lg mx-auto">Get a free audit and find out how a professional clinic website can bring you more patients.</p>
