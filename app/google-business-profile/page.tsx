    ...
    <>
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fade-in-up mt-12 lg:mt-0 block" style={{ animationDelay: "0.2s" }}>
              ...
              <img src="/images/gmb-hero.png" alt="Hero Illustration" className="relative max-w-[500px] h-auto object-contain mx-auto drop-shadow-sm transition-transform hover:scale-105" />
            </div>
          </div>
        </div>
</section>
      ...
      <section className="py-16 px-6 md:px-12 bg-[var(--color-primary)]">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-[var(--color-primary-fixed-dim)] mb-8 max-w-[512px] mx-auto">Get a free consultation and find out how well your Google Business Profile is performing.</p>
