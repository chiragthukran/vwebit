...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.vwebit.xyz/google-business-profile" },
  openGraph: {
    title: "Google Business Profile Optimization India | Vwebit",
    description: "Optimise your Google Business Profile to rank in Google Maps and get more local customers.",
    url: "https://www.vwebit.xyz/google-business-profile",
  },
};
    ...
    <>
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fade-in-up hidden lg:block" style={{ animationDelay: "0.2s" }}>
              ...
              <img src="/images/gmb-hero.png" alt="Hero Illustration" className="relative w-full max-w-[500px] h-auto object-contain mx-auto drop-shadow-sm transition-transform hover:scale-105" />
            </div>
          </div>
        </div>
</section>
      ...
      <section className="py-16 px-6 md:px-12 bg-[var(--color-primary)]">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-[var(--color-primary-fixed-dim)] mb-8 w-full max-w-[512px] mx-auto">Get a free consultation and find out how well your Google Business Profile is performing.</p>
