...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ── 1. HERO ─────────────────────────────────────────────── */}
      <section className="bg-[var(--color-surface-container-lowest)] border-b border-[var(--color-outline-variant)]">
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-[var(--color-on-surface-variant)] mb-8 leading-relaxed max-w-2xl animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 border border-[var(--color-primary)] text-[var(--color-primary)] font-semibold rounded-lg hover:bg-[var(--color-surface-container-low)] transition-colors"
              >
