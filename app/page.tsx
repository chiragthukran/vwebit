    ...
    <>
      ...
      <section className="relative border-b border-[var(--color-outline-variant)] overflow-hidden bg-white">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 md:px-12 py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/20 text-white text-xs font-semibold rounded-full mb-6 animate-fade-in backdrop-blur-sm">
                <IndianRupee className="w-3 h-3" aria-hidden="true" />
                Starting from ₹15,000
              </div>
              <h1 className="font-[var(--font-geist)] text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight mb-6 animate-fade-in-up">
                Get More Leads with a{" "}
                <span className="text-[var(--color-primary-fixed)]">Professional Website</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                <a
                  ...
                  className="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-[var(--color-primary)] font-semibold rounded-lg hover:bg-white/90 transition-colors shadow-sm"
                >
            ...
            {/* Right Column: Static Form (Desktop Only) */}
            <div className="hidden lg:block animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
              <div className="bg-white/95 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/20 relative overflow-hidden">
                <ConsultationForm />
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 md:px-12 bg-[var(--color-primary)]" aria-labelledby="cta-heading">
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <p className="text-[var(--color-primary-fixed-dim)] text-lg mb-8 max-w-[576px] mx-auto">
